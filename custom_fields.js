                        ...
                        return {
                            ...
                            custom_fields_preload: function (b) {
                                $.ajax({
                                    ...
                                    error: function () {
                                        a.notice("Failed to preload required data", !0)
                                    }
                                })
                            },
                            ...
                            setup_custom_fields: function (b) {
                                ...
                                g.length ? (a.setting("hideProductCustomFields") || g.after(custom_field_panel), d.length && "Save" === d.text() && d.text("Save (without Custom Fields)"),
                                    ...
                                    })) : a.notice("Custom Fields error : setup_custom_fields() : target html not found", !0);
                                console.log("-----------b3-----------");
                                console.log(b);
                                console.log("-----------b3----------");
                                ...
                                "products" === b &&
                                    (b = $("button.ui-button.ui-button--size-small.custom-fields-variant-button").on("click",
                                        function (b) {
                                            ...
                                            var g = !1;
                                            console.log("----------variantRowsLength------------");
                                            console.log(a.data("variantRowsLength"));
                                            console.log("-----------variantRowsLength-----------");

                                            a.data("variantRowsLength") ?
                                                g = b.find("td:last div:first a:first").prop("href").split("/").pop() : (g = $("#product_variant_id").val(), c.addClass("disabled"));
                                            console.log("----------g------------");
                                            console.log(g);
                                            console.log("-----------g-----------");
                                            if (g) {
                                        ...
                                        }), d = $(".new-variants-table__row td:last-child a:first-child"), a.data("variantRowsLength", d.length), d.length ? "" : (b.removeClass("btn-slim btn--icon next-field--connected next-field--connected--no-flexn"), b[0].style = "margin-left: .5em;", $("#product-multiple-options:first").after(b)))
                            },
